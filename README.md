...
You dismissed the questions — holding off until you tell me what direction you want. Whenever you're ready, let me know which of those (scope, orgs, action level) to run with and I'll start the sweep.

Most of my case studies live under [Mirabelle-Workspace](https://github.com/Mirabelle-Workspace) — design system experiments, prototypes, and works-in-progress where ideas get tested before they ship. Alongside it, [mirabelle-design-systems-org](https://github.com/mirabelle-design-systems-org) holds my component library work, [The-Wednesday-Labs](https://github.com/The-Wednesday-Labs) is the umbrella for digital tools built for animal welfare, and [Organisme-Respire](https://github.com/Organisme-Respire) is digital infrastructure for a Montréal-based qualitative urban research nonprofit.
